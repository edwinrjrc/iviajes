 ...
 * 
 */
package pe.com.innovaviajes.web.ivservicerentcar.controller;
...
import pe.com.innovaviajes.web.ivservicerentcar.dto.ConsultaViajeWebDto;
import pe.com.innovaviajes.web.ivservicerentcar.dto.RegistroVentaWebDto;
...
import pe.com.innovaviajes.web.ivservicerentcar.util.UtilConversionS;
import pe.com.innovaviajes.web.ivservicerentcar.util.UtilSecurity;
...
public class ViajeServiceController {
	...
	public ResponseEntity<Map<String, Object>> consultarViaje(
		...
		try {
			...
			if (numInfantes != null && !numInfantes.isEmpty()) {
			...
			if (numNinos != null && !numNinos.isEmpty()) {
	...
	public ResponseEntity<Map<String, Object>> consultarViaje2(@RequestBody ConsultaViajeWebDto consulta) throws IvServiceRentCarException {
	...
	private ConsultaViajeDto prepararDto(ConsultaViajeWebDto web) throws IvServiceRentCarException {
