 ...
 * 
 */
package pe.com.innovaviajes.web.ivservicerentcar.service.impl;
...
import pe.com.innovaviajes.web.ivservicerentcar.dto.AerolineaDto;
...
import pe.com.innovaviajes.web.ivservicerentcar.dto.AvionDto;
...
import pe.com.innovaviajes.web.ivservicerentcar.dto.HorarioRutaDto;
import pe.com.innovaviajes.web.ivservicerentcar.dto.HorarioVueloDto;
import pe.com.innovaviajes.web.ivservicerentcar.dto.OfertaEncontrada;
import pe.com.innovaviajes.web.ivservicerentcar.dto.PrecioOfertaDto;
import pe.com.innovaviajes.web.ivservicerentcar.dto.RutaTramoDto;
import pe.com.innovaviajes.web.ivservicerentcar.dto.TramoEscalaDto;
...
import pe.com.innovaviajes.web.ivservicerentcar.service.DestinoCiudadCatalogoService;
import pe.com.innovaviajes.web.ivservicerentcar.service.remote.RemoteServiceDestinoCiudad;
import pe.com.innovaviajes.web.ivservicerentcar.util.Constantes;
import pe.com.innovaviajes.web.ivservicerentcar.util.UtilIvDto;
import pe.com.innovaviajes.web.ivservicerentcar.util.UtilServiceViajes;
...
public class DestinoCiudadCatalogoServiceImpl implements DestinoCiudadCatalogoService {
	...
	public List<AeropuertoWebMostrarDto> consultaDestinos(String nombreDestino) throws IvServiceRentCarException {
		...
		} catch (IvServiceRentCarException e) {
	...
	private List<OfertaEncontrada> agregaOfertas(ConsultaViajeDto consultaViajeDto) throws IvServiceRentCarException {
	...
	private OfertaEncontrada generaOferta(int idOferta, ConsultaViajeDto consultaViajeDto) throws IvServiceRentCarException {
	...
	private List<RutaTramoDto> generaListaTramos(ConsultaViajeDto consultaViajeDto) throws IvServiceRentCarException {
	...
	private TramoEscalaDto generaTramoEscala() throws IvServiceRentCarException {
	...
	private RutaTramoDto generaRutaTramo(int idRutaTramo, int idTipoViaje) throws IvServiceRentCarException {
	...
	private HorarioRutaDto generaHorarioRuta(int idHorarioRuta) throws IvServiceRentCarException {
		HorarioRutaDto horarioRuta = new HorarioRutaDto();
	...
	private PrecioOfertaDto generarPrecioOferta(ConsultaViajeDto consultaViajeDto) throws IvServiceRentCarException {
	...
	private Date generaFechaHoraRuta() throws IvServiceRentCarException {
